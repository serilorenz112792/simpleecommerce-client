...
const ConfirmationModal = (props) => {
    ...
    return (
        <Dialog open={modalState} onClose={handleCloseModal}>
            <DialogTitle>
                <Typography variant="h5">{type === 'DELETE' ? 'Remove Item' : 'Purchase Item'}</Typography>
            </DialogTitle>
            <DialogContent>
            ...
            <DialogActions>
                ...
                <Button onClick={handleSubmit} variant="contained" color={type === 'DELETE' ? 'secondary' : 'primary'}>Yes</Button>
                <Button onClick={handleCloseModal} variant="contained" color="default">No</Button>
